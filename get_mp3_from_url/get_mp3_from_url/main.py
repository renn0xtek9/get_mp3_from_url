...
def main():
    ...
    parser = argparse.ArgumentParser(description="get_mp3_from_url downloads song from url (e.g. Youtube) in mp3 format.")
    parser.add_argument(
        "-b",
        "--batch",
    ...
    parser.add_argument("-a", "--already-downloaded", help="path to the cache files that keep track of already downloaded files", required=False,default=Path.home()/ ".get_mp3_from_url" / "song_cache.txt")
